...
Resolve the committed dependency versions through the shared installer in pinned
mode and its checksum verification. The source POM defines the build inputs.
